...
start_date = Variable.get('bitcoin_gold_export_start_date', '2009-01-03')
...
DAG = build_export_dag(
    dag_id='bitcoin_gold_export_dag',
    provider_uri=Variable.get('bitcoin_gold_provider_uri'),
    output_bucket=Variable.get('bitcoin_gold_output_bucket'),
